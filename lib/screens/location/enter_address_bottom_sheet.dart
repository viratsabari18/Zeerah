...
class EnterAddressBottomSheet extends StatefulWidget {
  ...
  const EnterAddressBottomSheet({super.key, required this.address});
              ...
              Expanded(
                child: RichText(
                  text: TextSpan(
                    ...
                    children: const [
                      TextSpan(text: "Himanshu, "),
                      TextSpan(text: "9140324761", style: TextStyle(fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
              ),
