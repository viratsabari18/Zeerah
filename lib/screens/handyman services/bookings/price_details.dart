      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              children: [
                _priceRow(context, UserMessages.price, '₹ 45.00', isRed: false),
                _divider(context),
                _priceRow(
                  context,
                ...
                _divider(context),
                _priceRow(context, UserMessages.subtotal, '₹ 50.00', isRed: false),
                _divider(context),
                _priceRow(context, UserMessages.tax, '₹ 5.63', isRed: true),
                _divider(context),
                _priceRow(
                  context,
