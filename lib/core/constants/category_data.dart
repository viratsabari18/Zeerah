  ...
  static const Map<String, List<CategoryItem>> categoryMap = {
    "Cleaning": [
      CategoryItem(
        ...
        price: "240",
        image: "lib/assets/images/cleaning_full_house.png",
      ...
      CategoryItem(
        ...
        price: "120",
        image: "lib/assets/images/cleaning_bathroom.png",
      ...
      CategoryItem(
        ...
        price: "150",
        image: "lib/assets/images/cleaning_kitchan.png",
      ...
      CategoryItem(
        ...
        price: "100",
        image: "lib/assets/images/cleaning_living_room.png",
    ...
    "Electrician": [
      CategoryItem(
        ...
        price: "80",
        image: "lib/assets/images/electrical_fan.png",
        color: Color(0xFFE8F5E9),
        rating: "4.8",
        howItsDone: [
          {"title": "Safety Check", "image": "lib/assets/images/electrical_fan.png"},
          {"title": "Blade Assembly", "image": "lib/assets/images/electrical_fan.png"},
          {"title": "Installation", "image": "lib/assets/images/electrical_fan.png"},
          {"title": "Speed Test", "image": "lib/assets/images/electrical_fan.png"},
        ],
        whatsIncluded: [
          "Fan mounting",
      ...
      CategoryItem(
        ...
        price: "60",
        image: "lib/assets/images/electrical_swicth.png",
        color: Color(0xFFE3F2FD),
        rating: "4.7",
        howItsDone: [
          {"title": "Terminal Check", "image": "lib/assets/images/electrical_swicth.png"},
          {"title": "Old Plate removal", "image": "lib/assets/images/electrical_swicth.png"},
          {"title": "New Installation", "image": "lib/assets/images/electrical_swicth.png"},
        ],
        whatsIncluded: [
          "Wiring verification",
          "New plate fitting",
      ...
      CategoryItem(
        ...
        price: "150",
        image: "lib/assets/images/electrical_wireing.png",
        color: Color(0xFFFFF3E0),
        rating: "4.9",
        howItsDone: [
          {"title": "Circuit Testing", "image": "lib/assets/images/electrical_wireing.png"},
          {"title": "Identify Fault", "image": "lib/assets/images/electrical_wireing.png"},
          {"title": "Wire Replacement", "image": "lib/assets/images/electrical_wireing.png"},
        ],
        whatsIncluded: [
          "Main panel check",
          "Joint tightening",
      ...
      CategoryItem(
        ...
        price: "200",
        image: "lib/assets/images/electrical_inverter.png",
        color: Color(0xFFF3E5F5),
        rating: "4.8",
        howItsDone: [
          {"title": "Terminal Check", "image": "lib/assets/images/electrical_inverter.png"},
          {"title": "Acid Leveling", "image": "lib/assets/images/electrical_inverter.png"},
          {"title": "Load Balancing", "image": "lib/assets/images/electrical_inverter.png"},
        ],
        whatsIncluded: [
      ...
      CategoryItem(
        ...
        price: "70",
        image: "lib/assets/images/electrical_light.png",
        color: Color(0xFFFFF9C4),
        rating: "4.7",
        howItsDone: [
          {"title": "Holder Check", "image": "lib/assets/images/electrical_light.png"},
          {"title": "Fitting Mounting", "image": "lib/assets/images/electrical_light.png"},
          {"title": "Illumination Test", "image": "lib/assets/images/electrical_light.png"},
        ],
        whatsIncluded: [
          "Bracket mounting",
    ...
    "Pest\nControl": [
      CategoryItem(
        ...
        price: "150",
        image: "lib/assets/images/cockroach_control.png",
        color: Color(0xFFFFEBEE),
        rating: "4.9",
        howItsDone: [
          {"title": "Inspection", "image": "lib/assets/images/cockroach_control.png"},
          {"title": "Gel Spotting", "image": "lib/assets/images/cockroach_control.png"},
          {"title": "Spray Shield", "image": "lib/assets/images/cockroach_control.png"},
        ],
        whatsIncluded: [
      ...
      CategoryItem(
        ...
        price: "350",
        image: "lib/assets/images/termite_control.png",
        color: Color(0xFFEFEBE9),
        rating: "4.9",
        howItsDone: [
          {"title": "Soil Drilling", "image": "lib/assets/images/termite_control.png"},
          {"title": "Chemical Injection", "image": "lib/assets/images/termite_control.png"},
          {"title": "Perimeter Shield", "image": "lib/assets/images/termite_control.png"},
        ],
        whatsIncluded: [
          "Foundation drilling",
      ...
      CategoryItem(
        ...
        price: "200",
        image: "lib/assets/images/beg_bugs_control.png",
        color: Color(0xFFE1F5FE),
        rating: "4.8",
        howItsDone: [
          {"title": "Steam Treatment", "image": "lib/assets/images/beg_bugs_control.png"},
          {"title": "Crevice Spraying", "image": "lib/assets/images/beg_bugs_control.png"},
          {"title": "Mattress Vacuuming", "image": "lib/assets/images/beg_bugs_control.png"},
        ],
        whatsIncluded: [
    ...
    "Plumber": [
      CategoryItem(
        ...
        price: "50",
        image: UserMessages.plumber,
        color: Color(0xFFE0F2F1),
        rating: "4.6",
        howItsDone: [
          {"title": "Washer Check", "image": UserMessages.plumber},
          {"title": "O-ring Replace", "image": UserMessages.plumber},
          {"title": "Pressure Test", "image": UserMessages.plumber},
        ],
        whatsIncluded: [
          "Washer Replacement",
          "Spout cleaning",
      ...
      CategoryItem(
        ...
        rating: "4.7",
        howItsDone: [
          {"title": "Leak Detection", "image": UserMessages.plumber},
          {"title": "Joint Inspection", "image": UserMessages.plumber},
          {"title": "Sealant Application", "image": UserMessages.plumber},
          {"title": "Pressure Test", "image": UserMessages.plumber},
        ],
        whatsIncluded: [
      ...
      CategoryItem(
        ...
        rating: "4.8",
        howItsDone: [
          {"title": "Flush Mechanism Check", "image": UserMessages.plumber},
          {"title": "Valve Adjustment", "image": UserMessages.plumber},
          {"title": "Leakproof Sealant", "image": UserMessages.plumber},
          {"title": "Full Flush Test", "image": UserMessages.plumber},
        ],
        whatsIncluded: [
          "Flush valve repair",
    ...
    "Appliance\nRepair": [
      CategoryItem(
        ...
        price: "250",
        image: UserMessages.applianceRepair,
        color: Color(0xFFE0F7FA),
        rating: "4.8",
        howItsDone: [
          {"title": "Filter Jet Wash", "image": UserMessages.applianceRepair},
          {"title": "Gas Pressure check", "image": UserMessages.applianceRepair},
          {"title": "Drain Clean", "image": UserMessages.applianceRepair},
        ],
        whatsIncluded: [
          "Indoor Jet wash",
          "Outdoor grill clean",
      ...
      CategoryItem(
        ...
        rating: "4.7",
        howItsDone: [
          {"title": "Compressor Diagnosis", "image": UserMessages.applianceRepair},
          {"title": "Gas Pressure Check", "image": UserMessages.applianceRepair},
          {"title": "Thermostat Testing", "image": UserMessages.applianceRepair},
          {"title": "Door Seal Inspect", "image": UserMessages.applianceRepair},
        ],
        whatsIncluded: [
      ...
      CategoryItem(
        ...
        rating: "4.9",
        howItsDone: [
          {"title": "Wall Strength Check", "image": UserMessages.applianceRepair},
          {"title": "Bracket Mounting", "image": UserMessages.applianceRepair},
          {"title": "Level Alignment", "image": UserMessages.applianceRepair},
          {"title": "Channel Tuning", "image": UserMessages.applianceRepair},
        ],
        whatsIncluded: [
